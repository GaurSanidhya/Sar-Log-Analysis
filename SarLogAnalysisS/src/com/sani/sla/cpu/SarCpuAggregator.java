...
public class SarCpuAggregator
{
	public static void main(String[] args) throws Exception
	{
		...
		FileInputFormat.addInputPath(job, new Path("/home/sanidhya/Data/cpu_sample_logs_02.txt"));
		FileOutputFormat.setOutputPath(job, new Path("/home/sanidhya/output/sar-logs-out-04"));
